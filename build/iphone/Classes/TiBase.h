...
// in simulator we redefine to format for ti_estimotes_proximity Developer console
...
{\
	NSString * exceptionName = [@"org.ti_estimotes_proximity." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ti_estimotes_proximity";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIti_estimotes_proximityNativeItemNone = -1, 
	UIti_estimotes_proximityNativeItemSpinner = -2,
	UIti_estimotes_proximityNativeItemProgressBar = -3,
	
	UIti_estimotes_proximityNativeItemSlider = -4,
	UIti_estimotes_proximityNativeItemSwitch = -5,
	UIti_estimotes_proximityNativeItemMultiButton = -6,
	UIti_estimotes_proximityNativeItemSegmented = -7,
	
	UIti_estimotes_proximityNativeItemTextView = -8,
	UIti_estimotes_proximityNativeItemTextField = -9,
	UIti_estimotes_proximityNativeItemSearchBar = -10,
	
	UIti_estimotes_proximityNativeItemPicker = -11,
	UIti_estimotes_proximityNativeItemDatePicker = -12,
	
	UIti_estimotes_proximityNativeItemInfoLight = -13,
	UIti_estimotes_proximityNativeItemInfoDark = -14,
	
	UIti_estimotes_proximityNativeItemDisclosure = -15,
	
	UIti_estimotes_proximityNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all ti_estimotes_proximity instances of
