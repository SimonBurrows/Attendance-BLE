...
//@interface ti_estimotes_proximityObject : NSObject
//@end

@interface ti_estimotes_proximityObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ti_estimotes_proximityObject class]])
		{
			for (NSString *key in [[(ti_estimotes_proximityObject*)o modules] allKeys])
			{
