...
/**
 Base class for all ti_estimotes_proximity views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the ti_estimotes_proximity view hierarchy (such as wrapped iOS UIViews) was touched.
