...
//Rare exceptions to indicate a bug in the _ti_estimotes_proximity code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ti_estimotes_proximity proxies.
 */
