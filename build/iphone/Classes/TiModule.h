...
/**
 The base class for all ti_estimotes_proximity modules
 */
...
/**
 ti_estimotes_proximity Platform calls this method on startup.
 */
-(void)startup;

/**
 ti_estimotes_proximity Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ti_estimotes_proximity Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ti_estimotes_proximity Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ti_estimotes_proximity Platform calls this method on resume.
 @param sender The sender of the event.
 */
