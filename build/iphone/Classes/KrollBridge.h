...
@interface ti_estimotes_proximityObject : KrollCoverageObject {
#else
@interface ti_estimotes_proximityObject : KrollObject {
#endif
@private
...
extern NSString * ti_estimotes_proximity$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ti_estimotes_proximityObject *_ti_estimotes_proximity;
    KrollObject* console;
	BOOL shutdown;
