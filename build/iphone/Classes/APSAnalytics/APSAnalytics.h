 ...
 * to send analytic data that can be viewed on the ti_estimotes_proximity Dashboard.
 *
 * For information on getting started with ti_estimotes_proximity Platform Services,
